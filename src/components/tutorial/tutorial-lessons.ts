...
export const tutorialLessons: TutorialLesson[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { title: "Add product modal", body: "Admins can open Add Product to choose a SKU, enter share quantity, and add a remark.", target: '[data-tutorial="partner-add-product"]', action: "click" },
      { title: "Search products", body: "Search within available stock before adding a product to the partner sheet.", target: '[data-tutorial="partner-modal-product-search"]', action: "type", value: "Whiskas", duration: 1800 },
      { title: "Share qty field", body: "Enter the quantity the partner will take. This is separate from current stock until the sheet is completed.", target: '[data-tutorial="partner-modal-share-qty"]', action: "type", value: "6", duration: 1600 },
      { title: "Review product", body: "Review opens a confirmation sheet. It prevents accidental partner share changes.", target: '[data-tutorial="partner-modal-review"]', action: "click" },
      { title: "Confirmation sheet", body: "Users review product, quantity, and approver before confirming. Tutorial mode does not complete the final write.", target: '[data-tutorial="confirmation-sheet"]', action: "point" },
    ],
  },
  {
    id: "restock",
